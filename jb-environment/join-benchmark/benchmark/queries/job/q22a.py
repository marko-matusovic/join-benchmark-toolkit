...
def instruction_set(db_path:str, operation_set: Operations[I,O]) -> QueryInstructions[I, O]:
    return QueryInstructions(
        s1_init = operation_set.from_tables(db_path, 'job', ['company_name','company_type','info_type','info_type','keyword','kind_type','movie_companies','movie_info','movie_info_idx','movie_keyword','title'], ['cn','ct','it1','it2','k','kt','mc','mi','mi_idx','mk','t',]),
        s2_filters = [
