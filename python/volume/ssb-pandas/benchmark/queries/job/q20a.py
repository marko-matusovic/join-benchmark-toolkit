...
def instruction_set(operation_set):
    return [
        [
            operation_set.from_tables('job', ['complete_cast','comp_cast_type','comp_cast_type','char_name','cast_info','keyword','kind_type','movie_keyword','name','title'], ['cc','cct1','cct2','chn','ci','k','kt','mk','n','t'])
        ],
        [
